...
class Start_Menu(Menu.Menu):
    ...
    def execute_menu(self):
        self.set_background_image('Assets/Images/Start_Menu_Background.jpg')
        self.play_music("Assets/Sounds/themeSong.mp3")
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if event.key == K_ESCAPE:
                        ...
                        self.isInMenu = False;
                        return Representations.gameStates["ON_GAMEPLAY"]
